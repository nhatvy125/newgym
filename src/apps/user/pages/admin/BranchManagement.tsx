          ...
          setBranches([
            {
              ...
              address: '123 Võ Văn Ngân, Phường Linh Chiểu, Quận Thủ Đức, TP.HCM',
              phone: '0909 123 456',
              email: 'thuduc@twelvefit.vn',
              status: 'ACTIVE',
            }
          ] as BranchResponse[]);
      ...
      <div className="relative z-10 flex-1 overflow-auto p-8 lg:p-12">
                      ...
                      <div className="grid grid-cols-3 gap-4 mb-6">
                        <div className="bg-white/5 p-3 rounded-2xl border border-white/5">
                          ...
                          <div className="flex items-center gap-1.5 font-black text-sm">
                            <Users size={14} className="text-red-500" /> 128
                          </div>
                        </div>
                        <div className="bg-white/5 p-3 rounded-2xl border border-white/5 text-center">
                          <p className="text-[8px] text-gray-500 font-black uppercase mb-1">Tình trạng</p>
                          <span className={`text-[9px] font-black uppercase ${branch.status === 'ACTIVE' ? 'text-green-500' : 'text-yellow-500'}`}>
                        ...
                        <div className="bg-white/5 p-3 rounded-2xl border border-white/5">
                          ...
                          <div className="flex items-center gap-1.5 font-black text-sm">
                            <Activity size={14} className="text-blue-400" /> 82%
                          </div>
                        </div>
                      </div>
                    </div>
        ...
        <div className="mt-12 flex gap-8 justify-center opacity-50">
           <div className="flex items-center gap-2 text-[10px] font-black uppercase tracking-[0.2em]">
              <CheckCircle2 size={14} className="text-green-500"/> {branches.filter(b => b.status === 'ACTIVE').length} Chi nhánh Online
           </div>
           <div className="flex items-center gap-2 text-[10px] font-black uppercase tracking-[0.2em]">
