...
export default function Sidebar() {
  ...
  const menuItems = [
    { icon: Home, label: 'Doanh thu', path: '/admin/dashboard' },
    { icon: Users, label: 'Hội Viên', path: '/admin/members' },
    { icon: Calendar, label: 'Lịch Học', path: '/admin/schedule' },
    { icon: Package, label: 'Gói Tập', path: '/admin/packages' },
    { icon: MapPin, label: 'Chi Nhánh', path: '/admin/branches' },
    ...
    >
      ...
      <div className="p-6 border-t border-gray-800 bg-black/10">
        ...
        <button
          ...
          className="flex items-center justify-center gap-2 w-full py-3 border border-gray-700 rounded-xl hover:bg-red-600 hover:border-red-600 hover:text-white transition-all text-[10px] font-black uppercase tracking-[0.2em]"
        >
